...
void VL53L0X_writeReg(struct VL53L0X* dev, uint8_t reg, uint8_t value)
{
	...
	buf[0] = reg;
	buf[1] = value;
	dev->last_status = HAL_I2C_Master_Transmit(dev->hi2c, (dev->address << 1) | 0, buf, 2, 1000);
...
void VL53L0X_writeReg32Bit(struct VL53L0X* dev, uint8_t reg, uint32_t value)
{
	...
	dev->last_status = HAL_I2C_Master_Transmit(dev->hi2c, (dev->address << 1) | 0, buf, 5, 1000);
...
{
  uint8_t value;
	HAL_I2C_Master_Transmit(dev->hi2c, (dev->address << 1) | 0, &reg, 1, 1000);
  //i2c_write(dev->address, &reg, 1);
	dev->last_status = HAL_I2C_Master_Receive(dev->hi2c, (dev->address << 1) | 1, &value, 1, 1000);
...
uint16_t VL53L0X_readReg16Bit(struct VL53L0X* dev, uint8_t reg)
{
  ...
  HAL_I2C_Master_Transmit(dev->hi2c, (dev->address << 1) | 0, &reg, 1, 1000);
  //i2c_write(dev->address, &reg, 1);
  dev->last_status = HAL_I2C_Master_Receive(dev->hi2c, (dev->address << 1) | 1, buf, 2, 1000);
...
uint32_t VL53L0X_readReg32Bit(struct VL53L0X* dev, uint8_t reg)
{
  ...
  HAL_I2C_Master_Transmit(dev->hi2c, (dev->address << 1) | 0, &reg, 1, 1000);
  //i2c_write(dev->address, &reg, 1);
  dev->last_status = HAL_I2C_Master_Receive(dev->hi2c, (dev->address << 1) | 1, buf, 4, 1000);
...
void VL53L0X_writeMulti(struct VL53L0X* dev, uint8_t reg, uint8_t* src, uint8_t count)
{
	HAL_I2C_Master_Transmit(dev->hi2c, (dev->address << 1) | 0, &reg, 1, 1000);
  //i2c_write(dev->address, &reg, 1);
	dev->last_status = HAL_I2C_Master_Receive(dev->hi2c, (dev->address << 1) | 1, src, count, 1000);
...
void VL53L0X_readMulti(struct VL53L0X* dev, uint8_t reg, uint8_t * dst, uint8_t count)
{
	HAL_I2C_Master_Transmit(dev->hi2c, (dev->address << 1) | 0, &reg, 1, 1000);
  //i2c_write(dev->address, &reg, 1);
	dev->last_status = HAL_I2C_Master_Receive(dev->hi2c, (dev->address << 1) | 1, dst, count, 1000);
...
//uint16_t VL53L0X_getLinearityGain(struct VL53L0X* dev)
